        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: Obx(()=>!ready.value ? FloatingActionButton.extended(
                onPressed: () {
                  if (workouts.length > 0 && title.text.isNotEmpty && description.text.isNotEmpty) {
                    saveWorkout();
                  } else {
                  ...
                  TypeAheadField(
                      ...
                      return Container(
                        ...
                        child: Row(
                          children: [
                            CachedNetworkImage(
                              imageUrl:
                              HttpClient.s3ResourcesBaseUrl + jsonObj['preview_animation_url'],
                    ...
                    onSuggestionSelected: (suggestion) {
                      ...
                      if (already == null) {
                        ...
                        showSnack('Warning!','Exercise is Already in the Workout!');
                      }
                    },
                  ),
                              ...
                              ListTile(
                                leading: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: HttpClient.s3ResourcesBaseUrl + workouts[index]['preview_animation_url'],
                                    placeholder: (context, url) =>
                                        CircularProgressIndicator(),
                                  ),
                                ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextField(
                                      controller: TextEditingController(text: workouts[index]['repetitions']
                                          .toString()),
                                  ...
                                  Expanded(
                                    child: TextField(
                                      controller: TextEditingController(text:  checkNullGetOne(workouts[index]['weight'].toString())),
                                      keyboardType:
                                  ...
                                  Expanded(
                                    child: TextField(
                                      controller: TextEditingController(
                                          text: checkNullGetOne(workouts[index]['sets'].toString())
                                      ),
                                      keyboardType: TextInputType.number,
                                      onChanged: (newValue) {
                                        workouts[index]['sets'] =
