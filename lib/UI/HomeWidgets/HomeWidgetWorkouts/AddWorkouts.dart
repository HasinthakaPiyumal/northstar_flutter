...
class AddWorkouts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void saveWorkout() async {
      ready.value = false;
      bool success = false;
      for(Map element in selectedUsers.value) {
        Map res = await httpClient.addWorkout({
          'workout_id': workoutID.toString(),
          'workouts': json.encode(workoutPlan.value),
          'count': workoutPlan.value.length.toString(),
          ...
          child: ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Workout Preset', style: TypographyStyles.boldText(16, Get.isDarkMode ? Themes.mainThemeColorAccent.shade500 : colors.Colors().lightBlack(1),)),
                  Obx(()=>Visibility(
                    child: InkWell(
                      onTap: (){
                        workoutPlan.clear();
              ...
              Obx(() => workoutPlan.isNotEmpty ? Container(
                  ...
                  children: [
                    Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text("Last Edit - " + (DateFormat("dd/MM/yyyy HH:mm").format(DateTime.parse(Utils.dateFormat(lastUpdatedDate)))).toString(),
                            style: TypographyStyles.normalText(14, Get.isDarkMode ? Themes.mainThemeColorAccent.shade500 : colors.Colors().deepGrey(1)),
                          ),
                        ]
                    ),
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 7,),
                            Text('${NumberFormat('00').format(workoutPlan.length)}',
              ...
              SizedBox(height: 25,),
              Text('Add Member', style: TypographyStyles.boldText(16, Get.isDarkMode ? Themes.mainThemeColorAccent.shade500 : colors.Colors().lightBlack(1),)),
              SizedBox(height: 16),
              TypeAheadField(
                hideOnEmpty: true,
                hideOnError: true,
                ...
                onSuggestionSelected: (suggestion) {
                  var jsonObj = jsonDecode(jsonEncode(suggestion));
                  var doesExist = selectedUsers.firstWhereOrNull((element) => element['id'] == jsonObj['user_id']);
                  if(doesExist == null) {
                    print(jsonObj['user']);
                ...
                itemBuilder: (context,index){
                  return Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(12),
                        color: Get.isDarkMode ? Colors.black : colors.Colors().selectedCardBG,
                      ),
                        ...
                        children: [
                          Row(
                            children: [
                              CircleAvatar(
                                backgroundImage: CachedNetworkImageProvider(
                                  HttpClient.s3BaseUrl + selectedUsers[index]['avatar_url'],
                                ),
                              ),
                              SizedBox(width: 15,),
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Text(selectedUsers[index]['email'],
                                    style: TypographyStyles.normalText(14, Get.isDarkMode ? Themes.mainThemeColorAccent.shade300 : colors.Colors().lightBlack(1)),
                                  ),
                                ],
                              ),
                            ],
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            if (workoutPlan.length > 0 && selectedUsers.length > 0) {
              ...
              showSnack('Workouts List Empty', 'Please add workouts to continue');
            }
          },
        ),
      ),
