...
class GymDateAndTime extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void makeASchedule() async {
      ready.value = false;
      int dateDifferent =
          selectedDay.value.difference(selectedStartTime.value).inDays;
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            '( ${gymObj['gym_services']['price']} per person )',
                            style: TypographyStyles.normalText(
                                16,
                                Get.isDarkMode
                                    ? Themes.mainThemeColorAccent.shade100
                          ...
                          Text(
                            "MVR ${(gymObj['gym_services']['price'] * clientIDs.length).toStringAsFixed(2)}",
                            style: TypographyStyles.boldText(
                                22,
                                Get.isDarkMode
                                    ? Themes.mainThemeColorAccent.shade100
