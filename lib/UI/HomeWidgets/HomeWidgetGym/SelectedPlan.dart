...
class SelectedPlan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void confirmAndPay(
        String package, int noOfDays, String startDate, double total) async {
      Get.to(() => PaymentSummary(
            orderDetails: [
              SummaryItem(
                head: 'Plan Price',
                value: "MVR ${plan["real_price"]}",
              ),
            ],
    ...
    // void confirmAndPay2(String package, int noOfDays, String startDate, double total) async{
    //
            ...
            children: [
              ...
              TextField(
                ...
                onTap: () {
                  ...
                  final DateRangePickerController _controller2 =
                      DateRangePickerController();
                              ...
                              child: Container(
                                ...
                                child: SfDateRangePicker(
                                  ...
                                  onSelectionChanged:
                                    ...
                                    start.value = DateFormat("MMM dd, yyyy")
                                        .format(date)
                                        .toString();
                                    end.value = DateFormat("MMM dd, yyyy")
                                        .format(date.add(Duration(
                                            days: plan['duration_amount'])))
                                        .toString();
                                  },
                                  monthCellStyle: DateRangePickerMonthCellStyle(
                                      ...
                                      todayTextStyle:
                                          TypographyStyles.normalText(16,
                                  ...
                                  headerStyle: DateRangePickerHeaderStyle(
                                    textStyle: TypographyStyles.boldText(20,
                                        Themes.mainThemeColorAccent.shade100),
                                  ),
                                  monthViewSettings:
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Icon(
                    ...
                    color: Get.isDarkMode
                        ? Themes.mainThemeColorAccent.shade500.withOpacity(0.3)
                        : AppColors.primary2Color,
                  ),
                ),
              ),
                ...
                child: Buttons.yellowFlatButton(
                  ...
                  onPressed: () {
                    if (start.value != "" && end.value != "") {
                      ...
                      showSnack("No Date(s) Selected",
                          "Please select Date(s) or Date range");
                    }
                  },
                ),
              ),
