    ...
    return Scaffold(
      ...
      padding: const EdgeInsets.all(16),
        child: Row(
          ...
          Expanded(
            child: Obx(()=> ready.value ? trainers.length != 0 ? Padding(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Container(width: trainers[index]['trainer']['is_insured']?Get.width-278:Get.width-220,child: Text(trainers[index]['name'].toString().capitalizeFirst.toString(),overflow: TextOverflow.ellipsis,style: TypographyStyles.title(16),)),
SizedBox(width: 10,),
                                          Visibility(
                                            ...
                                            child: Container(
                                              child: Padding(
                                                ...
                                                child: Text("INSURED",
                                                  style: TypographyStyles.boldText(10, AppColors.textOnAccentColor),
                                                ),
                                              ),
                                              decoration: BoxDecoration(
                                      ...
                                      Row(
                                        children: [
                                          Icon(Icons.star,color: AppColors.accentColor,),
                                          SizedBox(width: 10,),
                                          Text(trainers[index]['trainer']['rating'].toStringAsFixed(1).toString(),style: TypographyStyles.title(16),)
                                        ],
                                      )
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: trainers[index]['qualifications'].length != 0 ? Text("${trainers[index]['qualifications'][0]['title'].toString().capitalize} - ${trainers[index]['qualifications'][0]['description'].toString().capitalize}",
                                      ...
                                      Text("Classes: ${trainers[index]['trainer_classes'].length}")
                                    ],
                                  ),
                                ],
                              ),
