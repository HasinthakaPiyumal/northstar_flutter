  ...
  Widget build(BuildContext context) {
    ...
    void saveNote() async{
      ...
      Map res = await httpClient.saveClientNotes({
        ...
        'note': note.text,
        'service': selectedServiceValue.value == "other" ? otherService.text : selectedServiceValue.value.toString(),
      ...
      if (res['code'] == 200) {
        String nDescription = 'Your trainer has added ' +
            selectedServiceValue.value == "other" ? otherService.text : selectedServiceValue.value.toString()
            +'for you. You will be charged ${amount.text}MVR every ${selectedPaymentTerm.value}';
        if(selectedPaymentTerm.value == "Onetime"){
          nDescription = 'Your trainer has updated your payment for ${selectedServiceValue.value == "other" ? otherService.text : selectedServiceValue.value.toString()}. The amount is ${amount.text}';
        }
    ...
    List<DropdownMenuItem<String>> menuItems = [
      ...
      const DropdownMenuItem(child: Text("Channelling Fee"),value: "Channelling Fee"),
      const DropdownMenuItem(child: Text("Coach Fee"),value: "Coach Fee"),
      const DropdownMenuItem(child: Text("Exclusive Gym Fee"),value: "Exclusive Gym Fee"),
      const DropdownMenuItem(child: Text("Membership Fee"),value: "Membership Fee"),
      const DropdownMenuItem(child: Text("Coaching Fee"),value: "Coaching Fee"),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(()=>selectedClient.isNotEmpty ? SizedBox() : TypeAheadField(
                ...
                onSuggestionSelected: (suggestion) {
                  ...
                  var already = (selectedClient['user_id'] == jsonObj['user_id']);
                  if (already == false){
              ...
              Obx(()=>DropdownButtonFormField(
                ...
                items: menuItems,
                style: TypographyStyles.normalText(16, selectedServiceValue.value == "service" ? Get.isDarkMode ? Themes.mainThemeColorAccent.shade100.withOpacity(0.5) : colors.Colors().lightBlack(0.7) : Get.isDarkMode ? Themes.mainThemeColorAccent.shade100 : colors.Colors().lightBlack(1),),
              ...
              Obx(()=>DropdownButtonFormField(
                ...
                items: paymentTerms,
                style: TypographyStyles.normalText(16, selectedPaymentTerm.value == "Onetime" ? Get.isDarkMode ? Themes.mainThemeColorAccent.shade100.withOpacity(0.5) : colors.Colors().lightBlack(0.7) : Get.isDarkMode ? Themes.mainThemeColorAccent.shade100 : colors.Colors().lightBlack(1),),
                onChanged: (String? newValue){
                      ...
                      content: SizedBox(
                        ...
                        child: SfDateRangePicker(
                          ...
                          onSelectionChanged: (DateRangePickerSelectionChangedArgs args){
                            ...
                            date.text = args.value.toLocal().toString().split(' ')[0];
                          },
