...
class SelectedClientNote extends StatelessWidget {

  final int clientId;

  const SelectedClientNote({Key? key, required this.clientId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> sortClientNotes() async {
      ...
      allNotes.value = ClientNotesController.getClientNotesByClientId(clientId);
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(ClientNotesController.getClientNotesByClientId(clientId).first.client['name']),
      ),
      body: ListView(
        children: [
          SizedBox(height: 16,),

          Obx(() => activeNotes.isNotEmpty ? Padding(
                  ...
                  child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(clientNote.note,
                            style: TypographyStyles.normalText(13, Get.isDarkMode ? Themes.mainThemeColorAccent.shade300 : colors.Colors().lightBlack(1),),
                          ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: clientNote.active ? Colors.green : Get.isDarkMode ? colors.Colors().darkGrey(1) : colors.Colors().selectedCardBG,
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text("Amount:"),
                                  Text(authUser.user['currency']+ "  " + clientNote.amount.toStringAsFixed(2),
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text("Date - ",
                                    style: TypographyStyles.normalText(12, Get.isDarkMode ? Themes.mainThemeColorAccent.shade300 : colors.Colors().lightBlack(0.7),),
                                  ),
                                  Text("${DateFormat("yyyy-MM-dd").format(clientNote.startDate)}",
                                    style: TypographyStyles.boldText(12, Get.isDarkMode ? Themes.mainThemeColorAccent.shade100 : colors.Colors().lightBlack(1),),
                                  ),
                                ],
                              ),
                              Visibility(
                                visible: authUser.role == 'trainer' && clientNote.active,
                                child: MaterialButton(
                                  onPressed: (){
                                    CommonConfirmDialog.confirm('Mark as Done').then((value) async{
                                      if (value) {
