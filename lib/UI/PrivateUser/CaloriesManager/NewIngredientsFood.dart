  ...
  Widget build(BuildContext context) {
    ...
    void saveFood() async {
      ...
      foods.forEach((element) {
        calories += double.parse(element['calories'].toString()) * element['no_of_potions'];
        carbs += double.parse(element['carbs'].toString()) * element['no_of_potions'];
        proteins += double.parse(element['proteins'].toString()) * element['no_of_potions'];
        fat += double.parse(element['fat'].toString()) * element['no_of_potions'];
        satFat += double.parse(element['sat_fat'].toString()) * element['no_of_potions'];
        fibers += double.parse(element['fibers'].toString()) * element['no_of_potions'];
        ingredients.add({
          'id': element['id'],
          'name': element['name'],
          'no_of_potions': element['no_of_potions'],
          'potion': element['potion'],
          'total_calories': double.parse(element['calories'].toString()) * element['no_of_potions'],
        });
      });
      ...
      if (nameController.text.isNotEmpty && potionController.text.isNotEmpty) {
        ...
        showSnack('Fill All the Fields!', 'Name and Potion information are required!');
      }
    }
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(width: 16),
                                                              Obx(() => Text(foods[index]['no_of_potions'].toString(),
                                                                  style: TypographyStyles.title(21).copyWith(color: Get.isDarkMode ? colors.Colors().deepYellow(1) : colors.Colors().lightBlack(1),))),
                                                              SizedBox(width: 16),
                                                              Expanded(
                                                                child: ElevatedButton(
                                                                  onPressed: () {
                                      ...
                                      onPressed: () {
                                        showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            title: Text("NOTE !"),
                                            content: Text("You're About to remove this meal from your list."),
                                              ...
                                              TextButton(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .labelLarge!
                                                      .copyWith(fontSize: 17, color: colors.Colors().deepYellow(1)),
                                                ),
                                              ),
                                            ],
                                          ),
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              if (foods.length > 0) {
                ...
                showSnack('No Ingredients Added!', 'Please add some Ingredients to your Food');
              }
            },
          ),
        ),
