...
class UserCalories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    checkIfUserHasTrainers(){
      print( authUser.role == 'trainer' || ((authUser.user['client']['physical_trainer_id'] == null) &&
    ...
    return Scaffold(
      appBar: authUser.role == 'trainer' ? AppBar(
      ...
      body: SingleChildScrollView(
        child: Obx(()=> authUser.user['subscription'] != null ? ready.value ? homeData['macros'] != null ?
        Column(
            children: [
              Padding(
                    ...
                    Row(
                      children: [
                        TextButton(
                          ...
                          child: Row(
                            children: [
                              Text(selectedDay['name'],style: TextStyle(color: Colors.white),),
                              Icon(Icons.keyboard_arrow_down_rounded, color: Colors.white)
                            ],
                          ),
                        ),
                        authUser.role == 'trainer' || ((authUser.user['client']['physical_trainer_id'] == null) &&
                        (authUser.user['client']['diet_trainer_id'] == null)) ?
                        Container(
                          width: 32,
                          child: TextButton(
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text('Eaten'),
                                    Text(homeData['macros']['daily_calories'].toString() +' Cal', style: TypographyStyles.title(24),),
                                    SizedBox(height: 16),
                                    Text('Remaining'),
                                    Text( (homeData['macros']['target_calories'] - homeData['macros']['daily_calories']).round().toString() + ' Cal', style: TypographyStyles.title(24),),
                                  ],
                                ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(homeData['macros']['daily_carbs'].toStringAsFixed(1) +' / '+ homeData['macros']['target_carbs'].toString()+'g'),
                                    ],
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(homeData['macros']['daily_fat'].toStringAsFixed(1) +' / '+ homeData['macros']['target_fat'].toString()+'g'),
                                    ],
                                  ),
                                  VerticalDivider(width: 1),
                                  Container(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(homeData['macros']['daily_protein'].toStringAsFixed(1) +' / '+ homeData['macros']['target_protein'].toString()+'g'),
                                    ],
                                  )
                                ],
                              ),
                  ...
                  itemBuilder: (_,index){
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          Get.to(()=>EditMeal(
                            mealID: homeData['meals'][index]['id'],
                            foodList: homeData['meals'][index]['food_data'],
                            editMode: true,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Column(
                                        ...
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Text('Meal '+ (index+1).toString(), style: TypographyStyles.title(16),),
                                          SizedBox(height: 5,),
                                          Text(homeData['meals'][index]['calories'].toString() + ' Cal'),
                                        ],
                                      ),
                                    ),
          ...
          children: [
            ...
            Image.asset('assets/home/pro.png', height: Get.height * 0.25,),
            Icon(Icons.lock_outline, color: Colors.white.withOpacity(0.25), size: 64),
            SizedBox(height: 16),
            Text('Purchase a Pro Subscription \nto unlock this feature.', style: TextStyle(
