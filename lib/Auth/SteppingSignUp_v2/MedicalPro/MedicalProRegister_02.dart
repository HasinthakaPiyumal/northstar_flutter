...
class MedicalProRegisterSecond extends StatefulWidget {
  @override
  State<MedicalProRegisterSecond> createState() =>
      _MedicalProRegisterSecondState();
}

class _MedicalProRegisterSecondState extends State<MedicalProRegisterSecond> {
  ...
  void next() async {
    ...
    if (_countryController.text.isEmpty ||
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => MedicalProRegisterThree(),
        ),
      );
    }
  }
